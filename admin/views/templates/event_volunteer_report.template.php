	...
	<div class="modal-dialog modal-lg">  
		<div class="modal-content">
			<div class="modal-header">
                <h4 class="modal-title text-center" id="rsvp_report_title"><?= gettext("Download Event Volunteer Report");?> <i class="fa fa-info-circle info-black" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="<?= gettext('Below, choose the filters you wish to include in the downloaded report.'); ?>"></i></h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
            <div class="modal-body">
                <div class="col-md-12 mt-3 text-center">
                    <form class="form-horizontal" id="reportsForm" action="ajax.php?downloadEventVolunteersReport=1" method="post" role="form" style="display: block;">
                        <input type="hidden" name="csrf_token" value="<?= Session::GetInstance()->csrf; ?>">
                        <input type="hidden" name="groupid" value="<?= $_COMPANY->encodeId($groupid ?? 0); ?>">
                        <div id="rosterOptions2" style="display:block;">
                            <div class="row pt-3">
                                <div class="col-sm-6 text-left">
                                    <div class="form-group">
                                        <label for="s_group">Select Groups</label>
                                    ...
                                    <div class="form-group">
										...
										<select class="form-control" name="reportAction" onchange="filterMetaFields(this.value,'<?= htmlspecialchars($excludeAnalyticMetaFields); ?>')" >
                                ...
                                <div class="col-sm-5 text-left">
                                    <div class="form-group">
                                        ...
                                        <?php foreach($volunteer_fields as $key => $value){
                                        $checked = 'checked';?>
