<div id="theReportModal" class="modal fade" role="dialog">
	<div aria-label="<?= sprintf(gettext("%s Members Download Options"),$_COMPANY->getAppCustomization()['teams']['name']);?>" class="modal-dialog modal-lg">  
		<div class="modal-content">
			<div class="modal-header">
                <h4 class="modal-title text-center" id="rsvp_report_title"><?= sprintf(gettext("%s Feedback Download Options"),$_COMPANY->getAppCustomization()['teams']['name']);?></h4>
                <button aria-label="close" type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
            <div class="modal-body">
<form class="form-horizontal" action="ajax?downloadTeamsFeedbackReport" method="post" role="form" style="display: block;width:100% !important">
