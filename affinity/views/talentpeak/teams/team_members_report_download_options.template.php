...
<form class="form-horizontal" action="ajax_talentpeak?downloadTeamsMembersReport=<?= $_COMPANY->encodeId($groupid); ?>" method="post" role="form" style="display: block;width:100% !important">
