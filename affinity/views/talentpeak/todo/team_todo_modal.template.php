				...
				<div class="col-md-12">
                    <form id="todoForm">
                        ...
                        <div class="form-group">
                            <label><?= gettext("Task Title");?><span style="color: #ff0000;"> *</span></label>
                            <input  class="form-control" id="tasktitle"  placeholder="<?= gettext("Task title here");?>.." name="tasktitle" value="<?= $todo ? htmlspecialchars($todo['tasktitle']) : ''; ?>" required/>
                        </div>
                    ...
                    <?php } else { ?>
                        <div class="form-group">
                            <label><?= gettext("To be completed by");?><span style="color: #ff0000;"> *</span></label>
                            <select aria-label="<?= gettext('To be completed by');?>" name="assignedto" id="assignedto" class="form-control" required>
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label for="start_date" class="col-md-12"><?= gettext("Due Date");?> <?= gettext("(Optional)");?> <span style="font-size: xx-small">[<?= gettext("YYYY-MM-DD");?>]</span></label>
                                <div class="col-md-4 mb-2">
                                    <input type="text" class="form-control" id="start_date" value="<?= $todo ? $duedate : ''; ?>"  placeholder="YYYY-MM-DD" name="duedate" autocomplete="off" data-previous-value="" />
