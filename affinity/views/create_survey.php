    ...
    <script src="../vendor/js/surveyjs-1.11.2/survey.core.min.js"></script>  
    <script src="../vendor/js/surveyjs-1.11.2/index.min.js"></script>
    <script src="../vendor/js/surveyjs-1.11.2/survey.i18n.min.js"></script>
    <!--<script src="../vendor/js/surveyjs-1.11.2/survey-creator-core.i18n.min.js"></script>-->
