<div id="theReportModal" class="modal fade" >
	<div aria-label="<?= gettext("Download Event Volunteer Report");?>" class="modal-dialog modal-lg" aria-modal="true" role="dialog">  
		<div class="modal-content">
			<div class="modal-header">
                <h2 class="modal-title text-center" id="rsvp_report_title"><?= gettext("Download Event Volunteer Report");?></h2>
                <button aria-label="<?= gettext("close");?>"  id="btn_close" type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
            <div class="modal-body">
                <div class="col-md-12 mt-3 text-center">
                    <form class="form-horizontal" id="reportsForm" action="ajax_reports?downloadEventVolunteersReport=1" method="post" role="form" style="display: block;">
                    <input type="hidden" name="csrf_token" value="<?= Session::GetInstance()->csrf; ?>">
                        ...
                        <div id="rosterOptions2" style="display:block;">
                            ...
                            <select id="s_group" class="form-control" name="reportAction" onchange=filterMetaFields(this.value,'<?= $excludeAnalyticMetaFields; ?>') >
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" id="submit_action_button" name="submit" class="btn btn-primary"><?= gettext("Download Event Volunteer Report");?></button>
                        </div>
