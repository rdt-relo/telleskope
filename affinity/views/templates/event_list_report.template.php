<div id="theReportModal" class="modal fade">
	<div aria-label="<?= gettext("Download Events List Report");?>" class="modal-dialog modal-lg" aria-modal="true" role="dialog">  
		<div class="modal-content">
			<div class="modal-header">
                <h2 class="modal-title text-center" id="rsvp_report_title"><?= gettext("Download Events List Report");?></h2>
                <button id="btn_close" aria-label="close" type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
            <div class="modal-body">
                <div class="col-md-12 mt-3 text-center">
                    <form class="form-horizontal" id="reportsForm" action="ajax_reports.php?download_event_list_report=1" method="post" role="form" style="display: block;">
                ...
                <div class="form-group">
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group mt-3">
                            <button id="submit_action_button" type="submit" name="submit" class="btn btn-primary"><?= gettext("Download Report");?></button>
                        </div>
