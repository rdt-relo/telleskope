            ...
            return (
                (e.prototype = {
                    init: function () {
                        ...
                        (e.undoStack = []),
                            (e.redoStack = []),
                            (e.$left.find("optgroup").length || e.$right.find("optgroup").length) && ((e.callbacks.sort = !1), (e.options.search = !1)),
                            e.options.keepRenderingSort &&
                                ((e.skipInitSort = !0),
                                e.callbacks.sort !== !1 &&
                                    (e.callbacks.sort = function (e, o) {
                            ...
                            "function" == typeof e.callbacks.startUp && e.callbacks.startUp(e.$left, e.$right),
                            e.skipInitSort ||
                                "function" != typeof e.callbacks.sort ||
                                (e.$left.mSort(e.callbacks.sort),
                                e.$right.each(function (o, i) {
                                    t(i).mSort(e.callbacks.sort);
                                })),
                            e.options.search && e.options.search.left && ((e.options.search.$left = t(e.options.search.left)), e.$left.before(e.options.search.$left)),
                            e.options.search && e.options.search.right && ((e.options.search.$right = t(e.options.search.right)), e.$right.before(t(e.options.search.$right))),
                            e.events();
                    },
                    events: function () {
                        var e = this;
                        e.options.search &&
                            ...
                            (navigator.userAgent.match(/MSIE/i) || navigator.userAgent.indexOf("Trident/") > 0 || navigator.userAgent.indexOf("Edge/") > 0) &&
                    ...
                    moveToRight: function (e, o, i, n) {
                        var r = this;
                        return "function" == typeof r.callbacks.moveToRight
                            ? r.callbacks.moveToRight(r, e, o, i, n)
                            : "function" != typeof r.callbacks.beforeMoveToRight || i || r.callbacks.beforeMoveToRight(r.$left, r.$right, e)
                            ? (e.each(function (e, o) {
                                  var i = t(o);
                              ...
                              n || (r.undoStack.push(["right", e]), (r.redoStack = [])),
                              "function" != typeof r.callbacks.sort || i || r.$right.mSort(r.callbacks.sort),
                              "function" != typeof r.callbacks.afterMoveToRight || i || r.callbacks.afterMoveToRight(r.$left, r.$right, e),
                              r)
                            : !1;
                    },
                    moveToLeft: function (e, o, i, n) {
                        var r = this;
                        return "function" == typeof r.callbacks.moveToLeft
                            ? r.callbacks.moveToLeft(r, e, o, i, n)
                            : "function" != typeof r.callbacks.beforeMoveToLeft || i || r.callbacks.beforeMoveToLeft(r.$left, r.$right, e)
                            ? (e.each(function (e, o) {
                                  var i = t(o);
                              ...
                              n || (r.undoStack.push(["left", e]), (r.redoStack = [])),
                              "function" != typeof r.callbacks.sort || i || r.$left.mSort(r.callbacks.sort),
                              "function" != typeof r.callbacks.afterMoveToLeft || i || r.callbacks.afterMoveToLeft(r.$left, r.$right, e),
                              r)
                            : !1;
                    },
                    undo: function (t) {
