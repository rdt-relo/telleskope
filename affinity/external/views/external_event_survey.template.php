    ...
    <div aria-label="<?= $surveyData['survey_title']; ?>" class="modal-dialog modal-lg" aria-modal="true" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-12" id="surveyQuestionDiv">
    ...
    $(document).ready(function () {
        setTimeout(function () {
            ...
            $("#surveyContainer").Survey({
                model: survey,
                onComplete: saveExternalEventPreJoinSurveyResponse
            });

            function saveExternalEventPreJoinSurveyResponse(survey) {
                var responseJson = JSON.stringify(survey.data);
                



                joinExternalEvent('<?= $_COMPANY->encodeId($eventid); ?>',<?= $joinStatus; ?>,responseJson)
            }
            setTimeout(function(){
