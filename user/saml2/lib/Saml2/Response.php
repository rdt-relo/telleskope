    ...
    public function isValid($requestId = null)
    {
        ...
        try {
            ...
            if ($this->_settings->isStrict()) {
                ...
                // Check destination
				// Commented by Aman as this check does not work well behind the load balancer. HTTPS ---gets converted to HTTP
                if (0 && $this->document->documentElement->hasAttribute('Destination')) {
