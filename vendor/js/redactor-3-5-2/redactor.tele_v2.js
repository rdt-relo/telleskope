...
$R.add('module', 'editor', {
    ...
    _buildAccesibility: function()
    {
        ...
        $editor.attr({ 'aria-labelledby': 'redactor-voice-' + this.uuid, 'role': 'textbox' });
    },
...
$R.add('class', 'contextbar.button', {
    ...
    _init: function()
    {
        this.parse('<a onclick="redactorImagePostion()">');
            ...
            '<div class="redactor-modal-group"> \
                ...
                <form action="" class="redactor-modal-area"> \
                    ...
                    <div class="form-item form-item-align"> \
                        ...
                        <select id="selectImagePostion" name="align" aria-label="## image-position ##"> \
                            <option class="image-postion none" value="none">## none ##</option> \
                            <option class="image-postion left" value="left">## left ##</option> \
                            <option class="image-postion center" value="center">## center ##</option> \
                            <option class="image-postion right" value="right">## right ##</option> \
                        </select> \
                    </div> \
