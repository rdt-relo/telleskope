    ...
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p tabindex="-1" class="button-group" style="margin-top: 10px; text-align: center;"><button tabindex="0" type="button" role="button" aria-label="' + options.noBtn + '" class="btn btn-small confirm-dialog-btn-abort">' + options.noBtn + '</button> <button tabindex="0" type="button" role="button" aria-label="' + options.yesBtn + '" class="btn btn-small btn-danger confirm-dialog-btn-confirm">' + options.yesBtn + '</button></p>'
        }).click(function (e) {
          if (last && last !== self) {
        ...
        self.bind('click', function (e) {
          ...
          $(".popover > .popover-body > p > button.confirm-dialog-btn-abort").focus();
